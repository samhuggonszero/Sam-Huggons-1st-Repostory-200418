...
create table mendeley.sh_temp_visitor_id_sd_email_clickers_oct17_mar18(

Visitor_ID VARCHAR(108)  ENCODE LZO


)DISTKEY(Visitor_ID) SORTKEY(Visitor_ID);
GRANT SELECT ON mendeley.sh_temp_visitor_id_sd_email_clickers_oct17_mar18 TO GROUP mendeley_reader;


select * from  mendeley.sh_temp_visitor_id_sd_email_clickers_oct17_mar18 limit 10;

select visitor_id, count(*) from mendeley.sh_temp_visitor_id_sd_email_clickers_oct17_mar18 group by 1 having count(*)>1;

select  count(*) from mendeley.sh_temp_visitor_id_sd_email_clickers_oct17_mar18
