...
from (select distinct profile_id, groups from mendeley.SH_TEMP_feed_vs_library_exp1_080917) a
...
select profile_id, count(*) from (select distinct profile_id, groups from mendeley.SH_TEMP_feed_vs_library_exp1_080917) a
